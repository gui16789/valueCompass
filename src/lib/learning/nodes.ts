...
const rawKnowledgeNodes: KnowledgeNode[] = [
  ...
  },
  {
    ...
    period: "1989",
    school: "生活化研究",
    summary: "普通投资者入门友好，强调从生活观察出发，再回到公司分类、增长、财务、估值和持续跟踪验证。",
    coreIdeas: ["生活观察", "公司分类", "投资故事", "PEG", "持续跟踪"],
    books: ["《彼得·林奇的成功投资》"],
    aShareNotes: [
  ...
  {
    id: "book-stocks-for-long-run",
    type: "book",
    title: "《股市长线法宝》",
    period: "1994",
    school: "长期资产配置",
    summary: "从长期历史数据理解股票、债券、通胀、估值和复利，适合建立长期资产收益率框架。",
    coreIdeas: ["长期复利", "通胀保护", "股权风险溢价", "估值均值回归"],
    books: ["《股市长线法宝》"],
    aShareNotes: ["适合建立长期收益率常识，但不能直接把海外历史收益率套到 A 股。", ...sharedBoundary],
    misunderstandings: ["长期股票收益高，所以任何价格都可以买。"],
    practiceActions: ["比较股票、债券、现金在不同通胀环境下的真实收益。"],
    relatedIds: ["concept-margin-of-safety", "concept-do-nothing", "school-compounding"],
    order: 29.01
  },
  {
    id: "book-little-book-value-investing",
    type: "book",
    title: "《价值投资的秘密》",
    period: "2006",
    school: "价值投资入门",
    summary: "用简洁框架讲解低估、耐心、独立思考、财务质量和安全边际，适合把格雷厄姆思想转成行动清单。",
    coreIdeas: ["低估", "安全边际", "独立思考", "耐心"],
    books: ["《价值投资的秘密》"],
    aShareNotes: ["适合普通投资者建立低估研究流程，但必须结合 A 股财务质量和治理排雷。", ...sharedBoundary],
    misunderstandings: ["便宜就是价值投资。"],
    practiceActions: ["为一家公司写低估理由、反方理由和等待条件。"],
    relatedIds: ["book-intelligent-investor", "concept-margin-of-safety", "concept-pb-pe"],
    order: 29.02
  },
  {
    id: "book-beating-the-street",
    type: "book",
    title: "《战胜华尔街》",
    period: "1993",
    school: "生活化研究",
    summary: "彼得·林奇用大量案例展示如何从行业、公司故事、财务指标和持续跟踪中形成投资判断。",
    coreIdeas: ["案例研究", "投资故事", "公司分类", "盈利跟踪"],
    books: ["《战胜华尔街》"],
    aShareNotes: ["适合把 A 股公司写成可验证的投资故事，而不是只看新闻和概念。", ...sharedBoundary],
    misunderstandings: ["只学林奇买过什么，不学他如何验证。"],
    practiceActions: ["把一个 A 股案例写成故事、数据、风险、估值四栏。"],
    relatedIds: ["book-one-up", "person-peter-lynch", "concept-peg"],
    order: 29.03
  },
  {
    id: "book-most-important-thing",
    type: "book",
    title: "《投资最重要的事》",
    period: "2011",
    school: "风险与周期",
    summary: "霍华德·马克斯代表作，强调第二层思维、风险、周期、逆向、价格和防守。",
    coreIdeas: ["第二层思维", "风险控制", "周期", "逆向", "价格纪律"],
    books: ["《投资最重要的事》"],
    aShareNotes: ["适合训练反方委员思维，尤其适合 A 股高波动和高情绪环境。", ...sharedBoundary],
    misunderstandings: ["把逆向当成和市场唱反调。"],
    practiceActions: ["为一个热门行业写第二层思维版本的反方问题。"],
    relatedIds: ["school-contrarian", "concept-margin-of-safety", "concept-value-trap"],
    order: 29.04
  },
  {
    id: "book-mastering-market-cycle",
    type: "book",
    title: "《周期》",
    period: "2018",
    school: "周期投资",
    summary: "从信用、情绪、利润、风险偏好和估值理解周期位置，适合训练“知道自己大概在什么环境里”。",
    coreIdeas: ["周期位置", "情绪摆动", "信用周期", "风险偏好"],
    books: ["《周期》"],
    aShareNotes: ["适合周期股、新能源材料、地产链和金融股研究，但不应用来预测短期拐点。", ...sharedBoundary],
    misunderstandings: ["周期可以被精确预测。"],
    practiceActions: ["为一个行业写景气、估值、情绪和信用四项周期温度计。"],
    relatedIds: ["case-cyclical-coal", "case-huayou-603799", "concept-value-trap"],
    order: 29.05
  },
  {
    id: "book-reminiscences-stock-operator",
    type: "book",
    title: "《股票大作手回忆录》",
    period: "1923",
    school: "市场行为",
    summary: "以交易者视角揭示市场情绪、趋势、纪律和人性弱点，适合作为风险教育读物而非价值投资方法书。",
    coreIdeas: ["市场心理", "纪律", "趋势", "人性弱点"],
    books: ["《股票大作手回忆录》"],
    aShareNotes: ["适合理解情绪和交易风险，但不能替代企业研究和估值。", ...sharedBoundary],
    misunderstandings: ["把投机传奇当成可复制投资系统。"],
    practiceActions: ["记录一次冲动交易前后的情绪、理由和结果。"],
    relatedIds: ["concept-market-mr", "concept-do-nothing", "concept-circle-of-competence"],
    order: 29.06
  },
  {
    id: "book-contrarian-investment-strategies",
    type: "book",
    title: "《逆向投资》",
    period: "1979 / 1998",
    school: "逆向投资",
    summary: "系统讲解市场过度反应、低预期股票、心理偏差和逆向策略，适合训练从共识中寻找错误。",
    coreIdeas: ["逆向", "低预期", "过度反应", "心理偏差"],
    books: ["《逆向投资》"],
    aShareNotes: ["适合研究被冷落行业，但必须区分低预期机会和基本面永久恶化。", ...sharedBoundary],
    misunderstandings: ["越没人买越值得买。"],
    practiceActions: ["为一个冷门公司写低预期、改善证据和价值陷阱条件。"],
    relatedIds: ["school-contrarian", "concept-value-trap", "concept-margin-of-safety"],
    order: 29.07
  },
  {
    id: "book-little-book-beats-market",
    type: "book",
    title: "《股市稳赚》",
    period: "2005",
    school: "量化价值",
    summary: "乔尔·格林布拉特用“好公司 + 便宜价格”的魔法公式说明质量和估值结合的重要性。",
    coreIdeas: ["高资本回报", "低估值", "组合纪律", "再平衡"],
    books: ["《股市稳赚》"],
    aShareNotes: ["适合训练 ROIC 与估值结合，但 A 股需额外排除周期高点利润和财务异常。", ...sharedBoundary],
    misunderstandings: ["公式可以自动替代研究。"],
    practiceActions: ["用 ROIC 和估值筛出候选，再逐一写反方排雷。"],
    relatedIds: ["concept-roe", "concept-pb-pe", "concept-value-trap"],
    order: 29.08
  },
  {
    id: "book-value-investing-greenwald",
    type: "book",
    title: "《价值投资》",
    period: "2001",
    school: "现代价值投资",
    summary: "从资产价值、盈利能力价值、成长价值和特许经营权拆解企业价值，适合搭建分层估值框架。",
    coreIdeas: ["资产价值", "盈利能力价值", "特许经营权", "成长价值"],
    books: ["《价值投资》"],
    aShareNotes: ["适合把 A 股公司拆成资产底线、现有盈利和增长期权三层，但估值假设必须保守。", ...sharedBoundary],
    misunderstandings: ["所有成长都值得付钱。"],
    practiceActions: ["把一家公司的价值拆成资产价值、盈利价值和成长价值。"],
    relatedIds: ["book-security-analysis", "concept-intrinsic-value", "concept-moat"],
    order: 29.09
  },
  {
    id: "book-value-zhang-lei",
    type: "book",
    title: "《价值》",
    period: "2020",
    school: "长期主义",
    summary: "高瓴张磊关于长期主义、产业研究、价值创造和组织能力的投资思考。",
    coreIdeas: ["长期主义", "价值创造", "产业研究", "组织能力"],
    books: ["《价值》"],
    aShareNotes: ["适合理解产业变化和企业长期价值，但不能把宏大叙事替代财报与估值。", ...sharedBoundary],
    misunderstandings: ["长期主义就是一直持有。"],
    practiceActions: ["把一个长期行业判断拆成公司证据、财务指标和反方风险。"],
    relatedIds: ["timeline-li-lu-china", "school-compounding", "concept-circle-of-competence"],
    order: 29.1
  },
  {
    id: "book-graham-growth-stocks",
    type: "book",
    title: "《格雷厄姆成长股投资策略》",
    period: "2011",
    school: "低估成长",
    summary: "把格雷厄姆的安全边际与成长股研究结合，强调成长也需要价格纪律和财务验证。",
    coreIdeas: ["成长安全边际", "低估成长", "质量验证", "价格纪律"],
    books: ["《格雷厄姆成长股投资策略》"],
    aShareNotes: ["适合研究 A 股成长制造和医药，但要警惕赛道叙事透支估值。", ...sharedBoundary],
    misunderstandings: ["格雷厄姆只适合烟蒂股。"],
    practiceActions: ["为一家成长股写增长证据、估值折扣和失败条件。"],
    relatedIds: ["book-common-stocks", "book-intelligent-investor", "concept-margin-of-safety"],
    order: 29.11
  },
  {
    id: "book-business-cycles-investment",
    type: "book",
    title: "《逃不开的经济周期：历史，理论与投资现实》",
    period: "2005",
    school: "宏观周期",
    summary: "从历史、经济理论和市场现实理解经济周期，适合把企业研究放到需求、库存、信用和政策环境中。",
    coreIdeas: ["经济周期", "库存周期", "信用周期", "行业敏感度"],
    books: ["《逃不开的经济周期：历史，理论与投资现实》"],
    aShareNotes: ["适合周期行业、金融、地产链和出口制造研究，但宏观判断不能替代公司证据。", ...sharedBoundary],
    misunderstandings: ["懂宏观就能精准择时。"],
    practiceActions: ["给一家周期公司写需求、库存、信用、政策四项周期假设。"],
    relatedIds: ["book-mastering-market-cycle", "case-cyclical-coal", "case-chemical-cycle"],
    order: 29.12
  },
  {
    id: "book-wisdom-legendary-investors",
    type: "book",
    title: "《传奇投资人的智慧》",
    period: "投资大师文集",
    school: "投资大师框架",
    summary: "通过多位投资人的方法比较，理解价值、成长、逆向、指数、周期和风险控制之间的差异。",
    coreIdeas: ["多策略比较", "大师方法", "能力圈", "风格适配"],
    books: ["《传奇投资人的智慧》"],
    aShareNotes: ["适合建立投资方法地图，但不能把不同大师观点混成一锅。", ...sharedBoundary],
    misunderstandings: ["大师语录可以直接拼成系统。"],
    practiceActions: ["选择一种最适合自己的风格，并写出不适合自己的两种风格。"],
    relatedIds: ["person-warren-buffett", "person-peter-lynch", "person-seth-klarman"],
    order: 29.13
  },
  {
    id: "book-competitive-strategy",
    type: "book",
    title: "《竞争战略》",
    period: "1980",
    school: "产业分析",
    summary: "波特五力和通用战略经典，适合分析行业结构、竞争强度、供应商、客户和进入壁垒。",
    coreIdeas: ["五力模型", "成本领先", "差异化", "进入壁垒"],
    books: ["《竞争战略》"],
    aShareNotes: ["适合补强护城河分析，尤其是制造、消费、医药和资源品行业。", ...sharedBoundary],
    misunderstandings: ["龙头就是竞争优势。"],
    practiceActions: ["用五力模型拆解一家 A 股公司的行业结构。"],
    relatedIds: ["concept-moat", "case-midea-000333", "case-huayou-603799"],
    order: 29.14
  },
  {
    id: "book-super-stocks",
    type: "book",
    title: "《超级强势股》",
    period: "1984",
    school: "成长股研究",
    summary: "从高成长公司、利润率、销售效率、估值和预期差理解超级成长股的形成与风险。",
    coreIdeas: ["超级成长", "利润率", "预期差", "销售效率"],
    books: ["《超级强势股》"],
    aShareNotes: ["适合研究成长股爆发期，但要防止把短期强势和长期价值混淆。", ...sharedBoundary],
    misunderstandings: ["股价强就是基本面强。"],
    practiceActions: ["写出一家公司强势背后的基本面证据和估值风险。"],
    relatedIds: ["book-common-stocks", "concept-peg", "case-catl-300750"],
    order: 29.15
  },
  {
    id: "book-smartest-investment",
    type: "book",
    title: "《投资最聪明的事》",
    period: "指数投资",
    school: "低成本长期投资",
    summary: "强调低成本、分散、指数化、长期持有和行为纪律，适合普通投资者建立底仓和机会成本意识。",
    coreIdeas: ["低成本", "分散", "指数化", "行为纪律"],
    books: ["《投资最聪明的事》"],
    aShareNotes: ["适合提醒用户：如果无法持续研究个股，低成本分散可能优于勉强选股。", ...sharedBoundary],
    misunderstandings: ["指数投资不需要纪律。"],
    practiceActions: ["比较个股研究系统和指数化方案的时间成本、错误成本和回撤承受力。"],
    relatedIds: ["concept-do-nothing", "book-stocks-for-long-run", "concept-margin-of-safety"],
    order: 29.16
  },
  {
