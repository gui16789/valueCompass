...
const rawKnowledgeNodes: KnowledgeNode[] = [
  {
    ...
    coreIdeas: ["股票背后是企业", "资产负债表是风险底线", "价格必须和价值比较"],
    books: ["《证券分析》"],
    aShareNotes: ["适合理解低估资产、破净公司和周期底部研究，但不能只看账面便宜。"],
    misunderstandings: ["把低 PB 简单等同于低风险。"],
    practiceActions: ["读一家公司资产负债表，标记现金、负债、存货和应收账款。"],
  ...
  },
  {
    ...
    coreIdeas: ["安全边际", "市场先生", "防御优先", "低估组合"],
    books: ["《证券分析》", "《聪明的投资者》"],
    aShareNotes: ["A 股中可用于识别估值修复机会，但必须额外检查治理、退市风险和资产真实性。"],
    misunderstandings: ["以为越便宜越好，忽略价值陷阱。"],
    practiceActions: ["挑选一家公司，写出价格低估成立需要满足的三个事实。"],
  ...
  },
  {
    ...
    coreIdeas: ["买得足够便宜", "分散低估组合", "重视清算价值"],
    books: ["《巴菲特致股东的信》"],
    aShareNotes: ["A 股烟蒂机会常伴随信息质量、治理和壳价值变化，不能只看估值倍数。"],
    misunderstandings: ["忽略时间成本和基本面继续恶化。"],
    practiceActions: ["比较一家低估公司近三年的现金流和利润质量。"],
  ...
  },
  {
    ...
    coreIdeas: ["好公司合理价格", "护城河", "长期复利", "少数高质量机会"],
    books: ["《巴菲特致股东的信》"],
    aShareNotes: ["适合研究消费、家电、医药等长期商业模式，但高质量不代表任何价格都合理。"],
    misunderstandings: ["把龙头、品牌和高 ROE 直接等同于护城河。"],
    practiceActions: ["写出一家公司护城河的证据和反证。"],
  ...
  },
  {
    ...
    coreIdeas: ["长期成长质量", "管理层访谈", "研发与销售能力", "飞轮式增长"],
    books: ["《怎样选择成长股》"],
    aShareNotes: ["适合研究制造业和医药创新，但需要警惕高增长叙事被资本开支和竞争摊薄。"],
    misunderstandings: ["把收入增长当成价值创造。"],
    practiceActions: ["拆分一家成长公司的增长来源：量、价、份额、品类、并购。"],
  ...
  },
  {
    ...
    coreIdeas: ["从身边发现公司", "公司分类", "增长与估值匹配", "持续跟踪"],
    books: ["《彼得·林奇的成功投资》"],
    aShareNotes: ["适合消费、家电和服务业研究，但生活体验必须转化为财务和竞争证据。"],
    misunderstandings: ["把喜欢产品当成可以买公司。"],
    practiceActions: ["记录一次生活观察，并列出需要财报验证的指标。"],
  ...
  },
  {
    ...
    coreIdeas: ["永久损失风险", "安全边际", "逆向", "等待机会"],
    books: ["《安全边际》"],
    aShareNotes: ["A 股波动大，安全边际需要同时覆盖估值误差、周期误判和流动性冲击。"],
    misunderstandings: ["把安全边际当成固定折扣。"],
    practiceActions: ["给一项估值结论写出三个可能错的地方。"],
  ...
  },
  {
    ...
    coreIdeas: ["行业差异化估值", "政策与周期", "财报披露节奏", "不操作纪律"],
    books: ["《巴菲特致股东的信》", "《聪明的投资者》"],
    aShareNotes: ["金融、周期、消费、制造业需要不同模板，不能用一个 PE 公式套所有公司。"],
    misunderstandings: ["把海外成熟市场经验机械搬到 A 股。"],
    practiceActions: ["为一家公司选择估值模板，并说明为什么不用其他模板。"],
    relatedIds: ["case-bank", "case-cyclical-coal", "case-baijiu-consumer"],
    order: 8
  },
  {
    ...
    coreIdeas: ["净流动资产", "清算价值", "低估组合"],
    books: ["《证券分析》"],
    aShareNotes: ["需要特别检查退市、诉讼、关联交易和资产减值。"],
    misunderstandings: ["把低价股当成烟蒂投资。"],
    practiceActions: ["建立低估公司排雷清单。"],
  ...
  },
  {
    ...
    coreIdeas: ["保守估值", "催化因素", "风险补偿"],
    books: ["《聪明的投资者》"],
    aShareNotes: ["A 股深度价值必须识别价值释放路径，否则可能长期低估。"],
    misunderstandings: ["把估值低当成上涨理由。"],
    practiceActions: ["写出价值释放的触发条件。"],
  ...
  },
  {
    ...
    coreIdeas: ["成长来源", "增长质量", "估值匹配"],
    books: ["《怎样选择成长股》", "《彼得·林奇的成功投资》"],
    aShareNotes: ["制造业和医药成长需要关注竞争、资本开支和政策风险。"],
    misunderstandings: ["只看收入增速，不看自由现金流。"],
    practiceActions: ["拆解增长假设并做反向 DCF。"],
  ...
  },
  {
    ...
    coreIdeas: ["高质量现金流", "高 ROE 可持续性", "优秀管理层"],
    books: ["《巴菲特致股东的信》"],
    aShareNotes: ["要区分商业模式质量、财务质量和估值质量。"],
    misunderstandings: ["好公司可以无视价格。"],
    practiceActions: ["检查 ROE 来源：利润率、周转率、杠杆。"],
  ...
  },
  {
    ...
    coreIdeas: ["品牌", "成本优势", "网络效应", "转换成本"],
    books: ["《巴菲特致股东的信》"],
    aShareNotes: ["A 股中行业政策、渠道变迁和技术替代会快速改变护城河。"],
    misunderstandings: ["把市场份额高等同于护城河。"],
    practiceActions: ["为护城河列证据、反证和跟踪指标。"],
  ...
  },
  {
    ...
    coreIdeas: ["反共识", "基本面验证", "耐心等待"],
    books: ["《安全边际》"],
    aShareNotes: ["周期股逆向需要判断供需和利润中枢，不只是看股价跌幅。"],
    misunderstandings: ["为了逆向而逆向。"],
    practiceActions: ["写出市场共识、你的不同判断和验证数据。"],
  ...
  },
  {
    ...
    coreIdeas: ["保守假设", "折价", "错误容忍度"],
    books: ["《安全边际》", "《聪明的投资者》"],
    aShareNotes: ["A 股安全边际还要覆盖流动性、财务质量和治理风险。"],
    misunderstandings: ["用固定百分比代替安全边际思考。"],
    practiceActions: ["给估值结果写出安全边际来源。"],
  ...
  },
  {
    ...
    coreIdeas: ["长期持有", "再投资回报", "少做错误决策"],
    books: ["《巴菲特致股东的信》"],
    aShareNotes: ["A 股长期持有更需要跟踪行业结构和公司治理变化。"],
    misunderstandings: ["把长期持有变成不复盘。"],
    practiceActions: ["建立年度复盘问题清单。"],
  ...
  },
  {
    ...
    coreIdeas: ["市场先生", "安全边际", "证券分析"],
    books: ["《证券分析》", "《聪明的投资者》"],
    aShareNotes: ["适合训练保守、纪律和报表底线思维。"],
    misunderstandings: ["只学低估，不学风险控制。"],
    practiceActions: ["用市场先生框架写一段价格波动解释。"],
  ...
  },
  {
    ...
    coreIdeas: ["证据链", "保守估值", "报表分析"],
    books: ["《证券分析》"],
    aShareNotes: ["提醒 A 股研究必须回到披露文件和财务证据。"],
    misunderstandings: ["把故事当分析。"],
    practiceActions: ["把一条投资观点拆成事实、推断和观点。"],
  ...
  },
  {
    ...
    coreIdeas: ["能力圈", "护城河", "所有者收益", "好公司合理价格"],
    books: ["《巴菲特致股东的信》"],
    aShareNotes: ["适合建立企业所有者视角，而不是短期价格预测视角。"],
    misunderstandings: ["只记名言，不做估值和反证。"],
    practiceActions: ["写出一家公司的能力圈边界。"],
  ...
  },
  {
    ...
    coreIdeas: ["好生意", "多元思维模型", "反向思考"],
    books: ["《巴菲特致股东的信》"],
    aShareNotes: ["适合建立跨行业判断和反方清单。"],
    misunderstandings: ["把好公司口号化。"],
    practiceActions: ["用反向思考列出会让投资失败的条件。"],
  ...
  },
  {
    ...
    coreIdeas: ["闲聊法", "成长质量", "长期持有"],
    books: ["《怎样选择成长股》"],
    aShareNotes: ["适合研究制造业和科技产业链，但要警惕竞争恶化。"],
    misunderstandings: ["只看赛道，不看公司能力。"],
    practiceActions: ["为一家成长公司列出十个调研问题。"],
  ...
  },
  {
    ...
    coreIdeas: ["生活观察", "公司分类", "PEG"],
    books: ["《彼得·林奇的成功投资》"],
    aShareNotes: ["适合消费股观察，但体验不能替代财务验证。"],
    misunderstandings: ["喜欢产品等于看懂公司。"],
    practiceActions: ["把公司归类为缓慢增长、稳定增长、快速增长、周期等。"],
  ...
  },
  {
    ...
    coreIdeas: ["永久损失", "耐心", "保守假设"],
    books: ["《安全边际》"],
    aShareNotes: ["适合约束 A 股追涨和情绪化交易。"],
    misunderstandings: ["把低波动当低风险。"],
    practiceActions: ["为一家公司写永久损失风险清单。"],
  ...
  },
  {
    ...
    coreIdeas: ["低 PE", "稳健增长", "股息回报"],
    books: ["《约翰·聂夫谈投资》"],
    aShareNotes: ["适合理解低估蓝筹和股息资产，但需看分红可持续性。"],
    misunderstandings: ["把低 PE 当安全。"],
    practiceActions: ["比较股息率、利润稳定性和资本开支需求。"],
  ...
  },
  {
    ...
    coreIdeas: ["严谨证据", "资产价值", "盈利能力", "安全边际"],
    books: ["《证券分析》"],
    aShareNotes: ["适合作为财报和估值底层训练，不适合直接照搬历史筛选法。"],
    misunderstandings: ["以为读完就能机械选股。"],
    practiceActions: ["选择一个章节方法，应用到一家 A 股公司的年报。"],
  ...
  },
  {
    ...
    coreIdeas: ["防御型投资者", "市场先生", "安全边际"],
    books: ["《聪明的投资者》"],
    aShareNotes: ["适合建立不追涨、不预测市场、重视纪律的基础。"],
    misunderstandings: ["把防御等同于保守到不学习。"],
    practiceActions: ["写下你的防御型投资原则草案。"],
  ...
  },
  {
    ...
    coreIdeas: ["所有者收益", "资本配置", "护城河", "长期复利"],
    books: ["《巴菲特致股东的信》"],
    aShareNotes: ["适合训练从企业经营而非股价涨跌看公司。"],
    misunderstandings: ["只摘录金句，不写投资原则。"],
    practiceActions: ["把一封股东信转化为一条自己的投资原则。"],
  ...
  },
  {
    ...
    coreIdeas: ["十五点原则", "闲聊法", "成长质量"],
    books: ["《怎样选择成长股》"],
    aShareNotes: ["适合制造业和医药研究，但要结合公开披露而非传闻。"],
    misunderstandings: ["把调研当听故事。"],
    practiceActions: ["为一家公司写十五点检查草稿。"],
  ...
  },
  {
    ...
    books: ["《彼得·林奇的成功投资》"],
    aShareNotes: ["适合消费和服务公司入门，但必须避免主观喜好偏差。"],
    misunderstandings: ["只靠体验，不看财报。"],
    practiceActions: ["把一个消费品牌观察转化为研究问题。"],
  ...
  },
  {
    ...
    coreIdeas: ["风险控制", "安全边际", "耐心", "逆向"],
    books: ["《安全边际》"],
    aShareNotes: ["适合约束热门主题追逐和估值乐观假设。"],
    misunderstandings: ["把安全边际当成口号。"],
    practiceActions: ["为一次投资想法写反方质询。"],
